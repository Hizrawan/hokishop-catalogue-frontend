<template>
  <div
    class="flex h-screen w-screen flex-row dark:bg-gray-900 dark:text-gray-50"
  >
    <Sidebar />
    <div class="flex w-[calc(100vw-theme(spacing.64))] flex-1 flex-col">
      <header
        class="flex h-16 justify-end border-b px-4 py-2 dark:border-gray-800"
      >
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <div
              class="flex h-10 w-10 items-center justify-center rounded-full bg-gray-300 dark:bg-gray-700"
            >
